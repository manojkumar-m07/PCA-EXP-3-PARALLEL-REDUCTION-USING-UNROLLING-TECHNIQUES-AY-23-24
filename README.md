...
```
## OUTPUT:
<img width="1763" height="370" alt="image" src="https://github.com/user-attachments/assets/f97f0fdf-d086-4ea5-bbd6-73b4eeced19e" />

<img width="1766" height="307" alt="image" src="https://github.com/user-attachments/assets/c80190a0-2f74-422e-b62a-33062e6c96b4" />

<img width="1799" height="175" alt="image" src="https://github.com/user-attachments/assets/fc922080-3086-49de-a583-948d3497273b" />


## RESULT:
Thus, the program was executed using unrolling by 8 and unrolling by 16. It is observed that the Unrolling16 approach executed with a lower elapsed time than the Unrolling8 approach, using a grid size of 2048 blocks and a block size of 512 threads.
